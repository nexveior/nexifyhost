...
export default function MinecraftBudgetPage({ formatPrice, plansData }) {
  const plans = plansData['minecraft-budget'] || [];

  return (
    <section className="services-section">
      <div className="container">
        <div className="section-header">
          <span className="section-tag">// BUDGET ARCHITECTURE</span>
          <h2 className="section-title">Minecraft Budget Hosting Plans</h2>
          <p className="section-desc">Streamlined core infrastructure optimized for high-tick vanilla cooperative play and production plugin setups.</p>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '3.5rem', background: 'var(--bg-card)', border: '1px solid var(--border-glass)', padding: '2rem', borderRadius: 'var(--radius-lg)' }}>
          <h3 style={{ fontFamily: 'var(--font-heading)', marginBottom: '0.5rem', color: '#fff' }}>Need Custom Hardware Dimensions?</h3>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', marginBottom: '1.5rem' }}>Coordinate with an engineering dispatcher to review custom parameters across global locations.</p>
