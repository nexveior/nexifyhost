...
export default function DiscordBotPage({ formatPrice, plansData }) {
  const plans = plansData['discord-bot'] || [];

  return (
    <section className="services-section">
      <div className="container">
        <div className="section-header">
          <span className="section-tag" style={{ color: '#5865f2' }}>// DISCORD BOT HOSTING</span>
          <h2 className="section-title">Discord Bot Hosting Tiers</h2>
          <p className="section-desc">Supports Node.js, Python, Java, Bun, Deno, Go. Includes DDoS protection, 24/7 uptime, and instant ticket setup.</p>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '3.5rem', background: 'var(--bg-card)', border: '1px solid var(--border-glass)', padding: '2rem', borderRadius: 'var(--radius-lg)' }}>
          <h3 style={{ fontFamily: 'var(--font-heading)', marginBottom: '0.5rem', color: '#fff' }}>Custom App Framework</h3>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', marginBottom: '1.5rem' }}>Tailored hardware resource frameworks engineered to specific project dimensions.</p>
